...
export const gameStatusModel = {
  playable: { label: "Playable", demoLabel: "Public Demo Available", primaryAction: "Play Demo" },
  portfolio: { label: "Portfolio Title", demoLabel: "No Public Demo", primaryAction: "Discuss This Title" },
  "in-development": { label: "In Development", demoLabel: "In Development", primaryAction: "Discuss This Title" }
...
export function hasVerifiedDemo(game: Game) { return Boolean(getVerifiedDemoUrl(game)); }
export function getGameStatus(game: Game): GameStatus { return game.status === "playable" && !hasVerifiedDemo(game) ? "portfolio" : game.status; }
export function getGameStatusLabel(game: Game) { return gameStatusModel[getGameStatus(game)].label; }
export function getGameDemoStatusLabel(game: Game) { return gameStatusModel[getGameStatus(game)].demoLabel; }
export function getGamePrimaryActionLabel(game: Game) { return gameStatusModel[getGameStatus(game)].primaryAction; }
...
export function getGameBySlug(slug: string) { return games.find((game) => game.slug === slug); }
