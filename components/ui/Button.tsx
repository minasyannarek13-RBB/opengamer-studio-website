...
function getButtonClasses(variant: ButtonBaseProps["variant"] = "primary", className = "") {
  ...
  const styles = {
    ...
    link: "min-h-0 rounded-none px-0 py-0 text-emerald underline-offset-4 hover:translate-x-0.5 hover:underline"
  }[variant];
