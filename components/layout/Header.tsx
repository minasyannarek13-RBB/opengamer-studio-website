  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-ink/86 shadow-[0_14px_48px_rgba(0,0,0,0.28)] backdrop-blur-xl">
      <Container className="flex min-h-20 min-w-0 items-center justify-between gap-3 sm:gap-4">
        <Link href={getLocalizedHomePath(locale, "/")} aria-label="OpenGamer home" className="min-w-0 shrink rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald/70">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          <Button href={getLocalizedHomePath(locale, resolvedCtaHref)} className="hidden max-w-[13rem] md:inline-flex xl:max-w-none">
            {resolvedCtaLabel}
          </Button>
          <button
            ref={menuButtonRef}
