...
export function ManualHero() {
  return (
    <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#05070a]">
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[radial-gradient(circle_at_74%_30%,rgba(46,230,166,0.16),transparent_24rem),radial-gradient(circle_at_91%_21%,rgba(74,112,255,0.095),transparent_28rem),radial-gradient(circle_at_70%_86%,rgba(46,230,166,0.075),transparent_32rem),linear-gradient(180deg,rgba(255,255,255,0.025),transparent_34%)]"
      />
      <div
        aria-hidden="true"
        className="absolute inset-0 opacity-45 [background-image:linear-gradient(rgba(255,255,255,0.024)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] [background-size:72px_72px] [mask-image:linear-gradient(to_bottom,black,transparent_90%)]"
      />
      ...
      <Container className="grid gap-12 py-12 sm:py-16 lg:min-h-[calc(100svh-5rem)] lg:grid-cols-[0.74fr_1.26fr] lg:items-center lg:gap-9 lg:py-12 xl:grid-cols-[0.70fr_1.30fr] xl:gap-12 2xl:grid-cols-[0.68fr_1.32fr]">
        <div className="relative z-20 max-w-[42rem] lg:pr-1">
          ...
          <h1 className="mt-5 max-w-[12ch] text-balance text-5xl font-semibold leading-[0.93] tracking-[-0.03em] text-white sm:text-6xl lg:text-[4.35rem] xl:text-[4.8rem] 2xl:text-[5.15rem]">
          ...
          <div className="grid gap-4 sm:grid-cols-[1fr_0.42fr] sm:items-stretch lg:block">
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-4 p-5 sm:p-6 lg:p-7">
                <div>
                  <span className="text-[0.62rem] font-semibold uppercase tracking-[0.18em] text-emerald sm:text-[0.66rem]">Original Live Casino IP · In development</span>
                  <strong className="mt-1.5 block text-2xl font-semibold text-white sm:text-3xl">ELEMENTALS</strong>
                </div>
                <span className="hidden text-sm font-semibold text-white/80 xl:block">Explore concept →</span>
              </div>
            </Link>
