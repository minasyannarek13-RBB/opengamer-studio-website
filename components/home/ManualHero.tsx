...
export function ManualHero() {
  return (
    <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#05070a]">
      ...
      <Container className="grid gap-12 py-12 sm:py-16 xl:min-h-[calc(100svh-5rem)] xl:grid-cols-[0.72fr_1.28fr] xl:items-center xl:gap-12 xl:py-12 2xl:grid-cols-[0.70fr_1.30fr]">
        <div className="relative z-20 max-w-[43rem] xl:pr-2">
          <p className="premium-kicker text-xs font-semibold uppercase">iGaming development studio</p>
          <h1 className="mt-5 max-w-[12ch] text-balance text-5xl font-semibold leading-[0.93] tracking-[-0.03em] text-white sm:text-6xl lg:text-[4.25rem] xl:text-[4.7rem] 2xl:text-[5rem]">Build casino games. Extend delivery. <span className="text-emerald">Solve the product gap.</span></h1>
          <p className="mt-6 max-w-xl text-base leading-7 text-slate-300 sm:text-lg sm:leading-8">OpenGamer builds casino games and original iGaming products, and provides specialist development capacity across game, frontend, backend, mathematics and integration-oriented work.</p>
        ...
        <div className="relative z-10 xl:min-h-[705px] 2xl:min-h-[750px]" aria-label="Selected OpenGamer games and original product work">
          ...
          <div className="grid gap-4 sm:grid-cols-[1fr_0.42fr] sm:items-stretch xl:block">
            <Link href="/portfolio/elementals" className="group relative block aspect-[16/10] overflow-hidden rounded-[1.5rem] border border-white/15 bg-black/45 shadow-[0_30px_100px_rgba(0,0,0,0.44)] focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald/70 xl:absolute xl:left-0 xl:top-[3%] xl:h-[58%] xl:w-[73%] xl:aspect-auto xl:rounded-[1.75rem] xl:shadow-[0_42px_140px_rgba(0,0,0,0.52)]">
            ...
            <Link href="/portfolio/lc-app" className="group relative mx-auto block aspect-[9/16] w-full max-w-[16rem] overflow-hidden rounded-[1.55rem] border border-white/15 bg-[#030708] shadow-[0_30px_100px_rgba(0,0,0,0.48)] transition duration-300 hover:-translate-y-1 hover:border-emerald/35 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald/70 motion-reduce:transform-none motion-reduce:transition-none sm:max-w-none xl:absolute xl:right-0 xl:top-[8%] xl:h-[65%] xl:w-[25%] xl:aspect-auto xl:rounded-[1.9rem] xl:shadow-[0_42px_130px_rgba(0,0,0,0.62)]">
              ...
              <div className="pointer-events-none absolute inset-0 rounded-[inherit] ring-1 ring-inset ring-white/[0.055]" /><div className="absolute left-3 top-3 rounded-full border border-emerald/20 bg-black/70 px-2.5 py-1 text-[0.52rem] font-semibold uppercase tracking-[0.14em] text-emerald backdrop-blur sm:left-4 sm:top-4">B2B product direction</div><div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/85 via-black/35 to-transparent px-4 pb-4 pt-12 sm:px-5 sm:pb-5"><strong className="block text-base font-semibold text-white sm:text-lg">LC App</strong><span className="mt-1 block text-[0.68rem] leading-5 text-slate-300">In development</span></div>
            </Link>
          </div>
