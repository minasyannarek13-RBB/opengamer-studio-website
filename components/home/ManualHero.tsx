...
export function ManualHero() {
  return (
    <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#05070a]">
      ...
      <Container className="grid gap-10 py-12 sm:py-16 xl:min-h-[700px] xl:grid-cols-[0.86fr_1.14fr] xl:items-center xl:gap-10 xl:py-10 2xl:min-h-[760px] 2xl:grid-cols-[0.82fr_1.18fr] 2xl:gap-14">
        <div className="relative z-20 max-w-[46rem] xl:pr-2">
          ...
          <h1 className="mt-5 max-w-[13.5ch] text-balance text-[2.9rem] font-semibold leading-[0.95] tracking-[-0.03em] text-white sm:text-[3.55rem] lg:text-[3.8rem] xl:text-[3.85rem] 2xl:text-[4.45rem]">Build casino games. Extend delivery. <span className="text-emerald">Solve the product gap.</span></h1>
          <p className="mt-6 max-w-xl text-base leading-7 text-slate-300 sm:text-lg sm:leading-8 xl:text-[1.05rem]">OpenGamer builds casino games and original iGaming products, and provides specialist development capacity across game, frontend, backend, mathematics and integration-oriented work.</p>
        ...
        <div className="relative z-10 xl:min-h-[610px] 2xl:min-h-[675px]" aria-label="Selected OpenGamer games and original product work">
          ...
          <div className="grid gap-4 sm:grid-cols-[1fr_0.42fr] sm:items-stretch xl:block">
            ...
            <Link href="/portfolio/lc-app" className="group relative mx-auto block aspect-[9/16] w-full max-w-[16rem] overflow-hidden rounded-[1.55rem] border border-white/15 bg-[#030708] shadow-[0_30px_100px_rgba(0,0,0,0.48)] transition duration-300 hover:-translate-y-1 hover:border-emerald/35 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald/70 motion-reduce:transform-none motion-reduce:transition-none sm:max-w-none xl:absolute xl:right-0 xl:top-[9%] xl:h-[61%] xl:w-[24%] xl:aspect-auto xl:rounded-[1.9rem] xl:shadow-[0_42px_130px_rgba(0,0,0,0.62)] 2xl:h-[64%]">
