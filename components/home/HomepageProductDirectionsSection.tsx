  ...
  return (
    <section className="relative overflow-hidden border-b border-white/10 py-20 sm:py-28">
      ...
      <Container className="relative">
        ...
        <div className="mt-12 grid gap-5 xl:grid-cols-[1.55fr_0.65fr] xl:items-stretch">
          <Link href="/portfolio/elementals" className="group relative min-h-[430px] overflow-hidden rounded-[1.65rem] border border-white/12 bg-black/45 shadow-[0_34px_110px_rgba(0,0,0,0.34)] focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald/70 sm:min-h-[520px] xl:min-h-[570px]">
            <Image src="/assets/projects/elementals/expositions/nexus-studio-wheel.webp" alt="ELEMENTALS original Live Casino IP studio concept" fill sizes="(min-width:1280px) 68vw,100vw" className="object-cover transition duration-700 group-hover:scale-[1.018] motion-reduce:transition-none motion-reduce:group-hover:scale-100" />
          ...
          <Link href="/portfolio/lc-app" className="group relative overflow-hidden rounded-[1.65rem] border border-white/12 bg-[#06090b] p-5 shadow-[0_28px_90px_rgba(0,0,0,0.28)] focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald/70 sm:p-7 xl:flex xl:min-h-[570px] xl:flex-col">
            ...
            <div className="relative mt-6 flex min-h-[360px] flex-1 items-center justify-center overflow-hidden rounded-[1.25rem] border border-white/[0.08] bg-black/25 sm:min-h-[430px] xl:min-h-0"><div aria-hidden="true" className="absolute inset-x-[18%] top-[10%] h-[75%] rounded-full bg-emerald/[0.05] blur-3xl" /><Image src="/assets/projects/lc-app/optimized/lc-app-mobile-discover.webp" alt="LC App mobile product concept" fill sizes="(min-width:1280px) 27vw,70vw" className="object-contain object-center p-3 transition duration-700 group-hover:scale-[1.018] motion-reduce:transition-none motion-reduce:group-hover:scale-100 sm:p-4" /></div>
        ...
        <div className="mt-8 flex flex-col gap-5 border-t border-white/10 pt-7 sm:flex-row sm:items-center sm:justify-between"><p className="max-w-2xl text-sm leading-6 text-slate-500">Different product directions, deliberately kept separate: playable games, original Live Casino IP and an in-development B2B application concept.</p><div className="flex flex-col gap-3 min-[460px]:flex-row min-[460px]:flex-wrap"><Button href="/portfolio" variant="secondary" className="w-full min-[460px]:w-auto">Explore Portfolio</Button><Button href="/technology" variant="secondary" className="w-full min-[460px]:w-auto">Technology</Button></div></div>
      </Container>
    </section>
  );
}
