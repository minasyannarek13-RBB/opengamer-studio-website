      ...
      <section className="relative overflow-hidden border-b border-white/10 py-20 sm:py-28">
        ...
        <Container className="relative">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-[1.55fr_0.65fr] lg:items-stretch">
            <Link href="/portfolio/elementals" className="group relative min-h-[430px] overflow-hidden rounded-[1.65rem] border border-white/12 bg-black/45 shadow-[0_34px_110px_rgba(0,0,0,0.34)] focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald/70 sm:min-h-[520px] lg:min-h-[570px]">
              ...
              <div className="absolute left-5 top-5 flex flex-wrap gap-2 sm:left-7 sm:top-7">
                <span className="rounded-full border border-emerald/25 bg-[#07100d]/75 px-3 py-1.5 text-[0.58rem] font-semibold uppercase tracking-[0.15em] text-emerald backdrop-blur">Original Live Casino IP</span>
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 sm:p-8 lg:p-9">
                <p className="text-[0.64rem] font-semibold uppercase tracking-[0.2em] text-emerald">Original concept · Mechanics · Experience</p>
                <h3 className="mt-3 text-4xl font-semibold tracking-[-0.025em] sm:text-5xl">ELEMENTALS</h3>
                <p className="mt-4 max-w-xl text-sm leading-6 text-slate-300 sm:text-base sm:leading-7">A cinematic Live Casino show-game direction built around a central wheel, four elemental realms and a distinct host-led experience.</p>
                <span className="mt-6 inline-flex text-sm font-semibold text-white/85 transition group-hover:text-emerald">Explore ELEMENTALS →</span>
              </div>
            </Link>
            ...
            <Link href="/portfolio/lc-app" className="group relative overflow-hidden rounded-[1.65rem] border border-white/12 bg-[#06090b] p-5 shadow-[0_28px_90px_rgba(0,0,0,0.28)] focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald/70 sm:p-7 lg:flex lg:min-h-[570px] lg:flex-col">
              ...
              <div className="relative flex items-center justify-between gap-3">
                <span className="text-[0.6rem] font-semibold uppercase tracking-[0.18em] text-emerald">B2B product direction</span>
                <span className="rounded-full border border-white/10 bg-white/[0.025] px-2.5 py-1 text-[0.55rem] font-semibold uppercase tracking-[0.13em] text-slate-400">In development</span>
              </div>

              <div className="relative mt-6 flex min-h-[360px] flex-1 items-center justify-center overflow-hidden rounded-[1.25rem] border border-white/[0.08] bg-black/25 sm:min-h-[430px] lg:min-h-0">
                <div aria-hidden="true" className="absolute inset-x-[18%] top-[10%] h-[75%] rounded-full bg-emerald/[0.05] blur-3xl" />
                <Image src="/assets/projects/lc-app/optimized/lc-app-mobile-discover.webp" alt="LC App mobile product concept" fill sizes="(min-width:1024px) 27vw,70vw" className="object-contain object-center p-3 transition duration-700 group-hover:scale-[1.018] sm:p-4" />
              </div>

              <div className="relative mt-6">
                <h3 className="text-2xl font-semibold tracking-[-0.015em] sm:text-3xl">LC App</h3>
                <p className="mt-3 text-sm leading-6 text-slate-400">A separate product concept exploring social Live Casino engagement and creator-led product mechanics.</p>
          ...
          <div className="mt-8 flex flex-col gap-5 border-t border-white/10 pt-7 sm:flex-row sm:items-center sm:justify-between">
            <p className="max-w-2xl text-sm leading-6 text-slate-500">Different product directions, deliberately kept separate: playable games, original Live Casino IP and an in-development B2B application concept.</p>
            <div className="flex flex-wrap gap-3">
