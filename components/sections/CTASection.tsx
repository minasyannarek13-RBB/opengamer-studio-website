  ...
  return (
    <Section className="pb-20 sm:pb-24 lg:pb-28">
      <div className="relative isolate overflow-hidden rounded-[1.8rem] border border-white/10 bg-[#06090b] px-6 py-8 shadow-[0_34px_110px_rgba(0,0,0,0.32)] sm:px-8 sm:py-10 lg:px-11 lg:py-12">
        ...
        <div className="relative grid gap-9 lg:grid-cols-[minmax(0,1fr)_0.34fr] lg:items-end lg:gap-14 xl:gap-20">
          <div className="min-w-0">
            ...
            <div className="mt-7 flex flex-wrap gap-2 border-t border-white/10 pt-6" aria-label="Typical OpenGamer project scopes">
              {scopeSignals.map((item) => (
                <span key={item} className="inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.025] px-3 py-1.5 text-[0.66rem] font-semibold uppercase tracking-[0.1em] text-slate-400">
                  <span aria-hidden="true" className="h-1.5 w-1.5 rounded-full bg-emerald/80" />
                  {item}
                </span>
              ))}
            </div>
